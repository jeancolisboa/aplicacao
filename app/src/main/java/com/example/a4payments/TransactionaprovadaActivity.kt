...
class TransactionaprovadaActivity : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_transactionaprovada)
        ...
        val countDownTimer = object : CountDownTimer(atrasoEmMilissegundos, atrasoEmMilissegundos) {
            ...
            override fun onFinish() {
                runOnUiThread {
                    ...
                    val intent =
                        Intent(this@TransactionaprovadaActivity, RemovacartaoActivity ::class.java)
