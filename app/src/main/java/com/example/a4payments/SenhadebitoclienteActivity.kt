...
class SenhadebitoclienteActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_senhadebitocliente)

        findViewById<TextView>(R.id.meudeusdoceu).setOnClickListener {
