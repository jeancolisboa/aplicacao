...
class ModoEntradadoisActivity : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_modo_entradadois)
        ...
        val atrasoEmMilissegundos =
            4000L // Ajuste o valor para a duração desejada em milissegundos (3 segundos neste exemplo).
        ...
        val countDownTimer = object : CountDownTimer(atrasoEmMilissegundos, atrasoEmMilissegundos) {
            ...
            override fun onFinish() {
                runOnUiThread {
                    ...
                    val intent =
                        Intent(this@ModoEntradadoisActivity, ModalidadefinalcreditoActivity::class.java)
                    startActivity(intent)
