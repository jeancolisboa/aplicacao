...
class SenhacreditoavistaestabelecimentoActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_senhacreditoavistaestabelecimento)
        ...
        findViewById<TextView>(R.id.creditoteste).setOnClickListener {
